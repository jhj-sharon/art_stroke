    ...
    function html5Upload() {	
    	...
    	sUploadURL= '/comm/board/multiphotoUpload'; 	//upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : '/board/write/image',	//샘플 URL입니다.
 	        sCallback : '/resource/board/memberBoard.jsp',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
