	...
	<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
		<%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions" %>
			...
			<head>
				...
				<link rel="stylesheet" href="${contextPath}/resources/css/myPage/myPage-style.css">
				...
				<main class="main-style">
					...
					<section class="contents-wrap">
						<div class="mypagemainlist">
							<a href="${contextPath}/myPage/myPageMessage"><i class="fa-solid fa-envelope fa-lg"
									style="color: #155139;"></i></a>
						</div>
						<div class="mypagemain">
							<div class="mypagemainprofile" onclick="openPopup2()">
								<c:if test="${empty loginMember.profileImage}">
									<img src="${contextPath}/resources/img/memberProfile/defaultUser.png" alt="프로필 이미지">
								</c:if>
