      ...
      <div class="container-fluid px-4"> 
        <div class="admin-container"> 
            ...
            <div class="admin-main-nav-order">
                ...
                <div>
                    <form action="${adminCode}" method="get" id="reviewSearch" onsubmit="return searchValidate()">
    
                    <select name="key" id="search-key"  name="admin-main-nav-input"   placeholder="검색">
                        <option value="t">별점</option>
          ...
          <table class="admin-main-table" id="reviewTable">
                <thead>
                    <tr> 
                       <th colspan="2">리뷰번호</th> 
                        <th>이미지</th>
                        <th>내용</th>
                        <th>별점</th>
                        <th>등록일</th>
          ...
          <c:choose>
                          ...
                          <c:otherwise>
                              ...
                              <c:forEach var="reviewList" items="${reviewList}">
                                  <tr>
                                        <td><input type="checkbox" name="reviewChk" value="${reviewList.reviewId}" id="reviewChkbox" ></td>
         ...
         <div class="pagination-area">
            ...
            <div class="admin-main-footer">
                ...
                <button type="submit" class="admin-btn" id="reviewBtn">삭제</button>
