        ...
        <div class="product-infoArea" >
            ...
            <div class="product-detail-btn">
                <div class="ac-buy wrap ">
                    <a href="${contextPath}/product/productCart" class="btn buy" onclick="product_submit(1, '/exec/front/order/basket/', this)">
                        <span id="btnBuy" class="lang-buy">바로구매</span>
                    </a>
                </div>
                <div class="ac-basket wrap ">
                    <a href="#none" class="btn basket lang-basket" onclick="addtoCart(); product_submit(2, '/exec/front/order/basket/', this)">
                        장바구니
                    </a>
                </div>
       ...
       <div class="product-tabArea">
        ...
        <ul class="df-prd-tab-items">
            ...
            <li class="prd-tab df-use-prd-qna df-use-on">
                <a href="${contextPath}/product/productDetailQnA"><span class="df-prd-tab-item-qna" style="font-weight: bold;">제품Q&A</span></a>
            </li>
        </ul>
