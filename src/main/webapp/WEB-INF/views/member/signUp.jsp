...
<div class="ec-base-box typeThinBg agreeArea ">
  ...
  <ul class="check">
<li class="">
          <span>*SMS 수신</span> <input id="is_sms" name="is_sms" fw-label="is_sms" fw-msg=""  value="T" type="checkbox" class="agreeCheck"><label for="is_sms">동의</label></li>
      <li class="">
          <span>*이메일 수신</span> <input id="is_news_mail0" name="is_news_mail" fw-label="is_news_mail" fw-msg=""  value="T" type="checkbox" class="agreeCheck"><label for="is_news_mail0">동의</label> </li>
  </ul>
</div>
