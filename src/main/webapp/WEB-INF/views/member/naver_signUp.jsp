  ...
  <main class="sns_signUp-main-style">
      ...
      <section class="sns_signUp-contents-wrap">
        <form action="naver_signUp" method="post" onsubmit="return sns_signUpValidate()">
            ...
            <div >
                <div class="ec-solution-box naver" >
                    <p class="desc">
                    이용약관, 개인정보 수집 및 이용에 동의하신 후<br><strong class="snsName" id="sns_name" style="color:#2DB400">Naver</strong> 계정을 사용하여 회원가입이 가능합니다.
                </p></div>
