            ...
            <div class ="board_form_area">
                ...
                <c:choose>
                    <c:when test = "${!empty detail}">
                        <form id = "noticeWriteForm" action ="${contextPath}/alarmWrite?type=update&no=${detail.boardId}" method ="post" class = "widthfull">
                    ...
                    <c:otherwise>
                        <form id = "noticeWriteForm" action ="${contextPath}/board/alarmWrite?type=insert" method ="post" class = "widthfull">
                            <div id = "board_Write_title">
